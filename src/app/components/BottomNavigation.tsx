  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 bg-[#fafaf9] h-[80px] flex items-center justify-around px-[24px] pt-[2px] z-50">
      ...
      <button
        ...
        className={`relative z-10 flex h-[48px] w-[68px] flex-col items-center justify-center rounded-[8px] px-0 py-[4px] ${isExploreActive ? 'bg-[#d1fae5] shadow-[inset_0px_2px_4px_0px_rgba(0,0,0,0.1)]' : ''}`}
      >
        ...
        <span className={`font-['WenQuanYi_Zen_Hei:Medium',sans-serif] text-[11px] leading-[16.5px] ${isExploreActive ? 'text-[#065f46]' : 'text-[#78716c]'}`}>
          探索活動
        </span>
      </button>
      ...
      <button
        ...
        className={`relative z-10 flex h-[48px] w-[68px] flex-col items-center justify-center rounded-[8px] px-0 py-[4px] ${isCreateActive ? 'bg-[#d1fae5] shadow-[inset_0px_2px_4px_0px_rgba(0,0,0,0.1)]' : ''}`}
      >
        <div className="relative size-[20px] mb-[4px]">
        ...
        <span className={`font-['WenQuanYi_Zen_Hei:Medium',sans-serif] text-[11px] leading-[16.5px] ${isCreateActive ? 'text-[#065f46]' : 'text-[#78716c]'}`}>
          我的活動
        </span>
      </button>
      ...
      <button
        ...
        className={`relative z-10 flex h-[48px] w-[68px] flex-col items-center justify-center rounded-[8px] px-0 py-[4px] ${isSocialActive ? 'bg-[#d1fae5] shadow-[inset_0px_2px_4px_0px_rgba(0,0,0,0.1)]' : ''}`}
      >
        <div className="relative w-[22px] h-[20px] mb-[4px]">
        ...
        <span className={`font-['WenQuanYi_Zen_Hei:Medium',sans-serif] text-[11px] leading-[16.5px] ${isSocialActive ? 'text-[#065f46]' : 'text-[#78716c]'}`}>
          社群互動
        </span>
      </button>
      ...
      <button
        ...
        className={`relative z-10 flex h-[48px] w-[68px] flex-col items-center justify-center rounded-[8px] px-0 py-[4px] ${isProfileActive ? 'bg-[#d1fae5] shadow-[inset_0px_2px_4px_0px_rgba(0,0,0,0.1)]' : ''}`}
      >
        <div className="relative size-[20px] mb-[4px]">
        ...
        <span className={`font-['WenQuanYi_Zen_Hei:Medium',sans-serif] text-[11px] leading-[16.5px] ${isProfileActive ? 'text-[#065f46]' : 'text-[#78716c]'}`}>
          個人資料
        </span>
      </button>
    </div>
